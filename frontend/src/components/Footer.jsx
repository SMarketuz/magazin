        ...
        <Box background='#060F42' padding='20px' mt='40px' >
            ...
            <Box display='flex' justifyContent='space-around' color='white' flexDirection={{ xl: 'inherit', md: 'column', base: 'column' }}>
                ...
                <Box display='flex' alignItems='start' flexDirection='column' gap='10px'>
                    ...
                    <Link><Text fontSize='12px'>Aksiya</Text></Link>
                    <Link><Text fontSize='12px'>Kredit</Text></Link>
                    <Link><Text fontSize='12px'>To'lov va Dostavka</Text></Link>
                    <Link><Text fontSize='12px'>Garantiya</Text></Link>
                    <Link><Text fontSize='12px'>Murojat qilish</Text></Link>
                    <Link><Text fontSize='12px'>Yangiliklar</Text></Link>
                    <Link><Text fontSize='12px'>Biz Haqimizda</Text></Link>
                    <Link><Text fontSize='12px'>Maxfiylik siyosati</Text></Link>
                    <Link><Text fontSize='12px'>Bog'lanish</Text></Link>
                </Box>
                {/* 2 */}
                <Box display='flex' alignItems='start' flexDirection='column' gap='15px'>
                    <Heading fontSize='30px'>Xizmatlar</Heading>
                    <Link><Text fontSize='12px'>Magazindagi Tovarlar</Text></Link>
                    <Link><Text fontSize='12px'>Haqida Ma'lumot</Text></Link>
                    <Link><Text fontSize='12px'>Texnik xizmatlar</Text></Link>
                    <Link><Text fontSize='12px'>Kompyuter yordami</Text></Link>
                    <Link><Text fontSize='12px'>Hamkorlik</Text></Link>
                    <Link><Text fontSize='12px'>Hammasi</Text></Link>
                </Box>
                {/* 3 */}
                <Box display='flex' alignItems='start' flexDirection='column' gap='15px'>
